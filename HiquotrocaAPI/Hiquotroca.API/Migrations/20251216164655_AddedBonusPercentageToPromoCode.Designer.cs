...
namespace Hiquotroca.API.Migrations
{
    ...
    [Migration("20251216164655_AddedBonusPercentageToPromoCode")]
    partial class AddedBonusPercentageToPromoCode
    {
        /// <inheritdoc />
                    ...
                    b.OwnsOne("Hiquotroca.API.Domain.Entities.Posts.ValueObjects.PostLocation", "Location", b1 =>
                        {
                            ...
                            b1.HasOne("Hiquotroca.API.Domain.Entities.Country", null)
                                .WithMany()
                    ...
                    b.OwnsOne("Hiquotroca.API.Domain.Entities.Posts.ValueObjects.PostTaxonomy", "PostTaxonomyData", b1 =>
                        {
                            ...
                            b1.HasOne("Hiquotroca.API.Domain.Entities.ActionType", null)
                                .WithMany()
                                .HasForeignKey("ActionTypeId")
                                .OnDelete(DeleteBehavior.Restrict)
                                .IsRequired();

                            b1.HasOne("Hiquotroca.API.Domain.Entities.Category", null)
                                .WithMany()
                            ...
                            b1.HasOne("Hiquotroca.API.Domain.Entities.Subcategory", null)
                                .WithMany()
